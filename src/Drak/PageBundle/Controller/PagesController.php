...
use Drak\PageBundle\Form\PagesType;
...
class PagesController extends Controller
{
    ...
    public function menuAction()
    {
        ...
        $pages = $em->getRepository('PageBundle:Pages');

        return $this->render('PageBundle:ModuleUsed:Menu.html.twig',
            array('pages'=> $pages));
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DrakPageBundle:Pages')->findAll();
     ...
     * @Method("POST")
     * @Template("DrakPageBundle:Pages:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DrakPageBundle:Pages')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DrakPageBundle:Pages:edit.html.twig")
     */
